        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home'] . 'admin/noticias/crear' ?>" title="Añadir nueva noticia"> <i class="material-icons" title="Añadir noticia">add_circle</i></a>
                </div>
            </div>
        </div>
    </article>
        ...
        <article class="col s12 l6">
            <div class="card horizontal sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-content">
                        <?php if (!$row->imagen) { ?>
                            <i class="material-icons medium grey-text">image</i>
                        <?php } ?>
                        <h4>
                            <?php echo $row->titulo ?>
                        </h4>
                        <strong>URL amigable:</strong> <?php echo $row->slug ?>
                        <br>
