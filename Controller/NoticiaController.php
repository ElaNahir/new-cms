...
class NoticiaController
{
    ...
    public function borrar($id){
        ...
        // $archivo = $_SESSION['public']."img/".$noticia->imagen; (codigo anterior)
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $entradilla = filter_input(INPUT_POST, "entradilla", FILTER_UNSAFE_RAW);
            ...
            // $imagen_subida = ($_FILES['imagen']['name']) ? '/var/www/html'.$_SESSION['public']."img/".$_FILES['imagen']['name'] : ""; (anterior)
            $imagen_subida = ($_FILES['imagen']['name']) ? __DIR__."/../public/img/".$_FILES['imagen']['name'] : "";        // Corregido
