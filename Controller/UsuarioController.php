    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            if ($id == "nuevo"){
                ...
                //Mensaje y redirección
                $this->view->redireccionConMensaje("admin/usuarios","green","El usuario <strong>$usuario</strong> se ha creado correctamente.");
            }
            else{
                ...
                //Mensaje y redirección
                $this->view->redireccionConMensaje("admin/usuarios","green","El usuario <strong>$usuario</strong> se ha actualizado correctamente.");
            }
        }
